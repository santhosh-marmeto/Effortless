    ...
    fetch(
      ...
      .then((responseText) => {
       ...
       // changecolorvarient
        ...
        if (updatedcolor && previouscolor) previouscolor.innerHTML = updatedcolor.innerHTML;


        // custominventory status
        let updatedinventory = html.getElementById("custominventorystatus")
        let previousinventory = document.getElementById("custominventorystatus");
...
//         "cant deliver at your locations",
//         "fa-xmark",
//         "#C0392B",
//         "slide-in-fade-out"
//       );
...
//     var new_node = this.querySelector(".master-toast-notification").cloneNode(
//       true
//     );
...
// pincode checker fetching google sheet
